...
{
    Task CreateUserAsync(RegisterDTO registerDTO, List<string> roles, bool confirm = false);
    Task SigninUserAsync(LoginDTO loginDTO);
    ...
    Task HandleExistingUserAsync(string email);
